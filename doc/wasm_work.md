there is an example of how to use wasi's wasm in js:
...
const wasmFilePath = '/hello2.wasm'  // Path to our WASI module
...
the source code file in rust is :

```
#![feature(wasi_ext)]
fn main() {
    println!("Hello, world, nice to meet you die!");
}
```

as you can see, it add a macro to tell rustc,you need add some feature to support for wasi works on browser.

and compile command is : `rustc hello.rs --target=wasm32-wasi -C opt-level=z`
then hello.wasm is getted.
